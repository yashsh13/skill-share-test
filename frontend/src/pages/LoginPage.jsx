...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Heart, Sparkles, MessageCircle } from 'lucide-react';
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Let's continue your amazing journey ✨
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center space-x-2 cursor-pointer group">
                  <input 
                    type="checkbox" 
                    className="w-4 h-4 text-violet-500 border-violet-300 rounded focus:ring-violet-400 focus:ring-2"
                  />
                  <span className="text-gray-600 group-hover:text-violet-600 transition-colors">Remember me</span>
                </label>
                <a href="#" className="text-violet-500 hover:text-violet-700 font-semibold transition-colors">
                  Forgot Password?
                </a>
              </div>
          ...
          <div className="mt-8 flex justify-center">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-lg px-6 py-3 rounded-full shadow-lg border-2 border-violet-100">
              ...
              <span className="text-gray-700 font-semibold text-sm">Safe & Secure Login</span>
