...
// Header Component
export function Header({ isLoggedIn, onLogout ,myCoin}) {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <button className="hidden md:flex items-center justify-center w-12 h-12 md:w-auto md:px-6 md:py-3 bg-white border-2 border-violet-200 rounded-full hover:border-violet-400 hover:scale-105 transition-all shadow-lg hover:shadow-xl group cursor-pointer">
              ...
              <button className="hidden md:flex items-center justify-center w-12 h-12 md:w-auto md:px-6 md:py-3 bg-white border-2 border-violet-200 rounded-full hover:border-violet-400 hover:scale-105 transition-all shadow-lg hover:shadow-xl group cursor-pointer">
                <MessageCircle className="w-5 h-5 text-violet-600 group-hover:scale-110 transition-transform" />
                <a href="/chat"><span className="hidden md:block ml-2 font-semibold text-gray-700">Chat</span></a>
              </button>
              ...
              <button className="relative flex items-center justify-center w-12 h-12 md:w-auto md:px-6 md:py-3 bg-gradient-to-br from-blue-400 to-violet-400 rounded-full hover:scale-105 transition-all shadow-lg hover:shadow-xl group border-2 border-white cursor-pointer">
              ...
              <button className="flex items-center justify-center w-12 h-12 md:w-auto md:px-6 md:py-3 bg-gradient-to-br from-violet-400 to-pink-400 rounded-full hover:scale-105 transition-all shadow-lg hover:shadow-xl group border-2 border-white cursor-pointer">
              ...
              {isLoggedIn ? (
                <button 
                  onClick={onLogout}
                  className="flex items-center justify-center w-12 h-12 md:w-auto md:px-6 md:py-3 bg-gradient-to-br from-pink-400 to-red-400 rounded-full hover:scale-105 transition-all shadow-lg hover:shadow-xl group border-2 border-white cursor-pointer"
                >
